...
REQUIRED_PATHS = [
    ...
    "START.bat",
    "start.sh",
    "bin/providers/start-claude.sh",
    "bin/providers/start-claude.bat",
    "bin/providers/start-codex.sh",
    "bin/providers/start-codex.bat",
    "bin/providers/start-agy.sh",
    "bin/providers/start-agy.bat",
    "bin/providers/start-kimi.sh",
    "bin/providers/start-kimi.bat",
    "LICENSE",
    "README.md",
    "README_de.md",
    "CHANGELOG.md",
